...
Good that you have an abstract, probably should be finished though...
...
# good to have comments like this
...
# it might be useful to have some comments in this loop talking about what it is doing 
# based on what was talked about in class, or some questions if it still not clear
...
# Good, thanks for letting me know, helps on the grading front
...
gt(data = t) %>%
  ...
  # in the future tables you'll want to try to format the column headers more nicely
  # or eliminate that row altogether, but aside from that, this is a great looking table!
```
...
# Super nice table and elegant code creating it
```
...
# Not a huge problem since this is pretty much how it looks in the paper
```
...
# not sure this was easily accessible, I had trouble finding it
```
...
Great notes for replicated tables and figure. Overall, excellent comments throughout original Enos code. Might be useful to include comments/notes from class explaining the more complicated parts of the code. Jotting down your thoughts like you did really helps me when looking at your code/the decisions you made.
